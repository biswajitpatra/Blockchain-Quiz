            ...
            >
                ...
                <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
                        <Link href="/organizer">
                            <button className="transition hover:shadow shadow-xl duration-500 ease-in-out p-6 mt-6 text-center border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600 h-36">
                        ...
                        <Link href="/organizer">
                            <button className="transition duration-500 hover:shadow shadow-xl ease-in-out p-6 mt-6 text-center border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600 h-36">
                                <h3 className="text-2xl font-bold">
                                    Player &#10148;
                                </h3>
                                <p className="mt-4 text-xl">
