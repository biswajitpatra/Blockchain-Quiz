...
export default function Organizer() {
    ...
    const getStatus = (quiz) => {
        ...
        if (
            quiz.isRunning &&
            parseInt(quiz.startTime, 10) + parseInt(quiz.duration, 10) < now
        ) {
            return (
        ...
        <>
            ...
            >
                ...
                <h1 className="sticky top-0 text-3xl md:text-4xl font-bold text-center">
                    ...
                    <Link href="/newquiz">
                        <button className="bg-blue-500 text-white font-bold p-2 rounded-xl hover:ring mt-3 text-lg">
                            + Create quiz
                        </button>
                    </Link>
                </h1>
